/**
 * @license
 * Designed & Developed By Rishi Ramesh
 * Copyright (c) 2019
 * https://shiftorbit.com/
 *
 * Compiled: 12-02-2019
 *
        ...
        var e = !0,
            ...
            n = {
                ...
                addBinders: function() {
                    ...
                    var checkmob = /iPhone|iPad|iPod|Android/i.test(navigator.userAgent);
                    var t = !1;
                    $(".blip").mouseover(function() {
                       if (screen.width >= 699){
                        ...
                        {
                              $(".blip").removeClass("muted"), $(".caption").removeClass("active"), n.openBlip($(this));
                        }
                    }).mouseout(function() {
                ...
                blipHover: function(e) {
                    ...
                    switch ($(".caption h4").html(t), $(".caption .quadrant").attr("class", "").addClass("quadrant " + n), $(".caption .ring").html(r), n) {
                        case "language":
                            if(u=="new")
                            $(".caption .quadrant").html("Technical Event");
                            else
                              $(".caption .quadrant").html("Non Technical Event");
                            break;
                        case "platform":
                            if(u=="new")
                            $(".caption .quadrant").html("Technical Event");
                ...
                openBlip: function(e) {
                    ...
                    switch ($(".overlay").find("h1").html(t),$(".overlay").find(".link").html(i).attr("href", o),$(".overlay").find(".description").html(n), $(".overlay .quadrant").attr("class", "").addClass("quadrant " + a),$(".overlay").find(".ring").html(s), $(".overlay .quadrant").attr("class", "").addClass("quadrant " + a), a)  {
                      case "language":
                           if(u=="new")
                           	$(".overlay .quadrant").html("Technical Event");
                            else
                           	$(".overlay .quadrant").html("Non Technical Event");
							break;
						case "platform":
						  if(u=="new")
                           	$(".overlay .quadrant").html("Technical Event");
                     ...
                     $("body").addClass("detail"), openDetail = !0
